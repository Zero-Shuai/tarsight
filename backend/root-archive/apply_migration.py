...
# Add backend root to path to import shared utils from archive scripts.
...
def resolve_migration_file() -> Path:
    """Resolve the archived migration file across legacy and current layouts."""
    candidate_paths = [
        BACKEND_ROOT / "database" / "migrations" / "002_add_project_module_codes.sql",
        BACKEND_ROOT.parent / "supabase" / "migrations" / "002_add_project_module_codes.sql",
    ]
